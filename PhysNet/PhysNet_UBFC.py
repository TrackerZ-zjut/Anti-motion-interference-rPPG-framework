...
if __name__ == '__main__':
    ...
    modelDir = 'E:\\Han\\divide\\weight_150\\PhysNet_UBFC_150_3_epoch03.pth'  # trained model
    ...
    for iSub in range(1, nSub + 1):
        ...
        vidDir = 'E:\\Han\\UBFC_pictures\\' + subID
        ResultDir = 'E:\\Han\\UBFC_DATASET\\DATASET_2\\' + subID
        roi_File = ResultDir + '/roi_facedetector.mat'  # Original ROI coordinates tracked by KLT algorithm
        file2Save = ResultDir + '/PhysNet3D_UBFC_0721.mat'
        ...
        for n in range(winLength, nImages + 1, stepSize):  # 150,225,300,375...
            print('subject ' + str(subID) + ', windoew ' + str(n))
