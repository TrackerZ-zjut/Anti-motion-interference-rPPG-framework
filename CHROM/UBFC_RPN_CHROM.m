...
for iSubject = 1:nSubject
    ...
    for iImage =1:nImages
        ccurrImage = read(currentVideo, iImage);  % read video frame
    ...
    for n = winLength:stepSize:traceLength
        ...
        for iImage3 = n-winLength+1:n
            ...
            ROI_Weight_mutiscale  = F_multisacle( x_9weight,y_9weight,w_9weight,h_9weight, k, ImageW, ImageH); % 同一个东西
