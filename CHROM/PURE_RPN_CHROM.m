...
for iSub = 1:nSub
    for iVersion = 1:nVersion
        ...
        for iImage =1:nImages
            ...
            currImage = imread(imagePath1);
            vidHeight = size( currImage , 1 );
        ...
        for n =  winLength:stepSize:traceLength
            ...
            for iROI1 = 1:25
                ...
                ntraces1 = skinM*ntraces1;
                S1 = [3 -2 0; 1.5 1 -1.5]*ntraces1;
                p1 = S1(1,:) - S1(2,:)*std(S1(1,:))/std(S1(2,:));
                p1 = p1 - mean(p1);
                p1 = p1/std(p1);
                win_pulseEst1(iROI1,:) = p1;  %  signals extracted by CHROM
            ...
            for iImage2 = n-winLength+1:n
                imageName2 = imageList(iImage2+2).name;
                imagePath2 = [vidDir '\' imageName2];
                currImage2 = imread(imagePath2);
            ...
            for iROI2 = 1:9
                ...
                S2 = [3 -2 0; 1.5 1 -1.5]*ntraces2;
                p2 = S2(1,:) - S2(2,:)*std(S2(1,:))/std(S2(2,:));
                p2 = p2 - mean(p2);
                p2 = p2/std(p2);
                win_pulseEst2(iROI2, : ) = p2 ; %  signals extracted by CHROM
            end
            ...
            for iImage3 = n-winLength+1:n
                imageName3 = imageList(iImage3+2).name;
                imagePath3 = [vidDir '\' imageName3];
                currImage3 = imread(imagePath3);
                ...
                ROI_Weight_mutiscale  = F_multisacle( x_9weight,y_9weight,w_9weight,h_9weight, k, ImageW, ImageH); % get 5 ROI coordinates
            ...
            win_pulseEst3 = zeros( 5, winLength );
            for iROI3 = 1:5
                % CHROM algorithm
                ...
                ntraces3 = skinM*ntraces3;
                S3 = [3 -2 0; 1.5 1 -1.5]*ntraces3;
                p3 = S3(1,:) - S3(2,:)*std(S3(1,:))/std(S3(2,:));
                p3 = p3 - mean(p3);
                p3 = p3/std(p3);
                win_pulseEst3( iROI3, : ) = p3;  %  signals extracted by CHROM
            end
