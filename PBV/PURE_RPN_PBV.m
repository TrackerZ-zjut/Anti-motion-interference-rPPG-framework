    ...
    for iVersion = 1:nVersion
        ...
        for n =  winLength:stepSize:traceLength
            ...
            for iROI1 = 1:25
                ...
                ntraces1 = ntraces1 - ones(3,winLength);
                p1 = u_sig'*((ntraces1*ntraces1')\ntraces1);
                p1 = p1 - mean(p1);
                p1 = p1/std(p1);
                win_pulseEst1(iROI1,:) = p1;  %  signals extracted by PBV
            ...
            for iROI2 = 1:9
                ...
                ntraces2 = ntraces2 - ones(3,winLength);
                p2 = u_sig'*((ntraces2*ntraces2')\ntraces2);
                p2 = p2 - mean(p2);
                p2 = p2/std(p2);
                win_pulseEst2(iROI2, : ) = p2 ; %  signals extracted by PBV
            end
            ...
            for iROI3 = 1:5
                ...
                ntraces3 = ntraces3 - ones(3,winLength);
                p3 = u_sig'*((ntraces3*ntraces3')\ntraces3);
                p3 = p3 - mean(p3);
                p3 = p3/std(p3);
                win_pulseEst3( iROI3, : ) = p3; %  signals extracted by PBV
            end
